...
with urllib.request.urlopen(urllib.request.Request(args.url,headers={'User-Agent':'FaceMorph-Preview/0.1 build-acquisition'}), timeout=60) as response, archive.open('wb') as target:
