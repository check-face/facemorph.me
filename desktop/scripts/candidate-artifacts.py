...
def collect(bundle, output, platform, revision):
    ...
    (output / 'candidate.json').write_text(json.dumps({'schemaVersion': 1, 'platform': platform,
        ...
        'nativeRuntimeBundled': False, 'modelsBundled': False, 'files': files}, indent=2) + '\n')
...
if __name__ == '__main__':
    ...
    if args.verify:
        ...
        collect(args.bundle, args.output, args.platform, args.revision)
