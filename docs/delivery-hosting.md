...
| Optional diagnostics | Private Cloudflare Worker/KV, session opt-in, 30-day expiry. Workers Free confirmed by the operator. Quota failures must not block generation. |
